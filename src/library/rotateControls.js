...
// not sure why this is messing up, it is used
...
function onDocumentMouseMove(event) {
  ...
  targetRotation =
    targetRotationOnMouseDown + (mouseX - mouseXOnMouseDown) * 0.008;
}
...
function onDocumentTouchMove(event) {
  if (event.touches.length === 1) {
    ...
    targetRotation =
      targetRotationOnMouseDown + (mouseX - mouseXOnMouseDown) * 0.01;
  }
}
